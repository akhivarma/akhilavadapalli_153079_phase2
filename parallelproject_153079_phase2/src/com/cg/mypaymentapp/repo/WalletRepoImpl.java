...
public class WalletRepoImpl implements WalletRepo 
{
	...
	public boolean save(Customer customer) 
	{
		try( Connection con = WalletDBUtil.getConnection()) 
		{
			...
			PreparedStatement pstm = con.prepareStatement("insert into accounts values(?,?,?)");
	...
	public Customer findOne(String mobileNo) 
	{
		...
		try( Connection con = WalletDBUtil.getConnection()) 
		{
		    ...
		    con.setAutoCommit(false);
			PreparedStatement pstm = con.prepareStatement("select * from accounts where mobileNo=?");
	...
	public Customer depositAmount(String mobileNo, BigDecimal amount) {
		...
		try( Connection con = WalletDBUtil.getConnection()) 
		{
			try
			{
			    ...
			    PreparedStatement pstm1 = con.prepareStatement("update accounts set walletBalance=? where mobileNo=?");
	...
	public Customer fundTransfer(String sourceMobileNo, String targetMobileNo,
		...
		try( Connection con = WalletDBUtil.getConnection()) 
		{
			try
			{
				...
				con.setAutoCommit(false);
				PreparedStatement pstm3 = con.prepareStatement("select * from accounts where mobileNo=?");
			    ...
			    PreparedStatement pstm4 = con.prepareStatement("update accounts set walletBalance=? where mobileNo=?");
